...
- Select text inside one finalized assistant reply and open an accessible annotation editor.
...
- Navigate in both directions: timeline card to quote, and quote marker to its annotation.
